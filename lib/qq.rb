#encoding=utf-8
#以下不需要改动
APPID = CONF['qq_api']['api_key'].to_s
APPKEY = CONF['qq_api']['api_sercet']
REDURL = '&redirect_uri=' + File.join(CONF['static_domain'], 'qq_callback.html')
...
class Qq
    ...
    {token: @token, openid: @openid, auth: @auth}
	end
